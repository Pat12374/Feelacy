...
export const metadata = {
  title: "Wines",
  description: "Explore wines by color and style from independent WineBloom sellers.",
};
...
export default function WinesPage() {
  return <div className="wt-container py-10">
    ...
    <p className="mt-4 max-w-2xl text-[var(--ink-soft)]">Choose a wine collection. Every variety links to currently available offers from independent WineBloom sellers.</p>
